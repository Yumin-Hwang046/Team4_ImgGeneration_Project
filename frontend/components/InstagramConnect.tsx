...
function buildMetaAuthUrl(): string {
...
export default function InstagramConnect({ variant = 'login' }: InstagramConnectProps) {
  const handleLogin = () => {
    try {
  ...
  if (variant === 'signup') {
    return (
      ...
      >
        ...
        <span className="font-semibold text-sm">과 연동하기</span>
      </button>
    )
  }
  ...
  return (
    ...
    >
      ...
      <span className="font-semibold">으로 로그인</span>
    </button>
  )
}
