...
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "generated" / "merged" / "exp8_sdxl_base"
...
JOBS = [
    {
        ...
        "prompt": (
            ...
            "very large subject scale, strong composition, grounded on the table plane, "
    ...
    },
    {
        ...
        "prompt": (
            ...
            "very large close composition, rich bakery mood, realistic tabletop contact, "
    ...
    },
    {
        ...
        "prompt": (
            ...
            "very large subject scale, clean cafe composition, realistic shadow and table grounding, "
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Compose exp8 images via SDXL Base img2img with dish background mapping.")
...
def main() -> None:
    ...
    try:
        ...
        for idx, job in enumerate(JOBS):
            outputs.append(run_job(pipe, job, args.output_dir, args.steps, args.guidance, args.strength, 400 + idx))
        log_langfuse_trace(
            name="image_generator.exp8_sdxl_base",
            input={
            ...
            tags=["image_generator", "experiment", "exp8", "sdxl"],
        )
    except Exception as e:
        log_langfuse_trace(
            name="image_generator.exp8_sdxl_base.error",
            ...
            metadata={"duration_sec": time.time() - start_time},
            tags=["image_generator", "experiment", "exp8", "sdxl", "error"],
        )
        raise
