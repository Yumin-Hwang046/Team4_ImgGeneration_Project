...
| 2026.04.09 | 모델 | 실험 스크립트/테스트 데이터 정리 |  | ✅완료 |
| 2026.04.10 | 모델 | 결과 저장 구조 정리 · 실험 반복 실행 흐름 개선 |  | ✅완료 |
| 2026.04.14 | 모델 | 마스크 기반 이미지 재생성 방식 도입 · 배경 교체 안정화 시도 |  | ✅완료 |
| 2026.04.15 | 서비스 | 상권/캘린더/추천 등 서비스 기능 반영 |  | ✅완료 |
| 2026.04.16 | 백엔드/연동 | Instagram 연동 기능 추가 |  | ✅완료 |
| 2026.04.16 | 실험/관측 | 실험 로그/추적 도입 |  | 🧪실험 |
